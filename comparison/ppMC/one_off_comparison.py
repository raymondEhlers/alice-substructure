...
plot_attribute_compare(
    ...
    mine=Input(df=mine_df, attribute="jet_pt_matched", name="Mine"),
...
mask_true = laura_df["zgMatch"] < 0.2
laura_df_copy.loc[mask_true, "rgMatch"] = -0.005
plot_attribute_compare(
    laura=Input(df=laura_df_copy[laura_df_copy["ptJetMatch"] > 20], attribute="rgMatch", name="Laura"),
    mine=Input(df=mine_df[mine_df["jet_pt_matched"] > 20], attribute="soft_drop_z_cut_02_matched_delta_R", name="Mine"),
...
plot_attribute_compare(
    ...
    mine=Input(df=mine_df[mine_df["jet_pt_data"] > 20], attribute="soft_drop_z_cut_02_data_delta_R", name="Mine"),
...
plot_attribute_compare(
    laura=Input(df=leticia_df_copy[leticia_df_copy["ptJetMatch"] > 20], attribute="rgMatch", name="Leticia"),
    mine=Input(df=mine_df[mine_df["jet_pt_matched"] > 20], attribute="soft_drop_z_cut_04_matched_delta_R", name="Mine"),
    output_name="compare_true_rg_z_cut_04",
    axis=bh.axis.Regular(21, -0.02, 0.4),
)
plot_attribute_compare(
    laura=Input(df=leticia_df_copy[leticia_df_copy["ptJet"] > 20], attribute="rg", name="Leticia"),
    mine=Input(df=mine_df[mine_df["jet_pt_data"] > 20], attribute="soft_drop_z_cut_04_data_delta_R", name="Mine"),
    output_name="compare_det_rg_z_cut_04",
    axis=bh.axis.Regular(21, -0.02, 0.4),
)
...
# Plot true pt
plot_attribute_compare(
    laura=Input(df=leticia_df, attribute="ptJetMatch", name="Leticia"),
    mine=Input(df=mine_df, attribute="jet_pt_matched", name="Mine"),
    output_name="compare_true_leticia",
    log_y=True,
)
# Plot det pt
plot_attribute_compare(
    laura=Input(df=leticia_df, attribute="ptJet", name="Leticia"),
    mine=Input(df=mine_df, attribute="jet_pt_data", name="Mine"),
    output_name="compare_det_leticia",
    log_y=True,
)
