...
void plotfinalUncertPanels()
{
  ...
  if (mine < 2)
    cout << "integral" << shape[0]->Integral(1, 8) << " " << 1 - shape[0]->Integral(1, 1) / shape[0]->Integral(1, 8)
       << endl;
  ...
  if (mine < 2) {
    shapeuncorr2[0]->GetXaxis()->SetTitle("k_{T}");
  ...
  if (mine == 0)
    shape[0]->GetYaxis()->SetTitle("(1/N_{jet}) dN_{jet}/d#it{k}_{T,leading}");
  if (mine == 1)
    shape[0]->GetYaxis()->SetTitle("(1/N_{jet}) dN_{jet}/d#it{k}_{T,leading}");
  if (mine == 2)
    shape[0]->GetYaxis()->SetTitle("(1/N_{jet}) dN_{jet}/d#it{k}_{T,dynamical-k_{T}}");
  if (mine == 3)
    shape[0]->GetYaxis()->SetTitle("(1/N_{jet}) dN_{jet}/d#it{k}_{T,dynamical-t_{f}}");
  if (mine == 4)
    shape[0]->GetYaxis()->SetTitle("(1/N_{jet}) dN_{jet}/d#it{k}_{T,leading}");
  ...
  if (mine == 0)
    lat->DrawLatex(0.93, 0.73, "Soft drop z_{cut} = 0.4 #beta = 0");
  if (mine == 1)
    lat->DrawLatex(0.93, 0.73, "Soft drop z_{cut} = 0.2 #beta = 0");
  if (mine == 2)
    lat->DrawLatex(0.93, 0.73, "Dynamical k_{T}");
  if (mine == 3)
    lat->DrawLatex(0.93, 0.73, "Dynamical t_{f}");
  if (mine == 0)
  ...
  if (mine == 0)
    h1_ratio->GetXaxis()->SetTitle("#it{k}_{T}");
  if (mine == 1)
    h1_ratio->GetXaxis()->SetTitle("#it{k}_{T}");
  if (mine == 2)
    h1_ratio->GetXaxis()->SetTitle("#it{k}_{T}");
  ...
  if (mine == 1)
    cOutFile = Form("result_ledingktzcut02.root");
  if (mine == 2)
