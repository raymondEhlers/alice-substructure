...
def skim_cross_check_task_to_uniform_output(
    ...
    for i, array in enumerate(uproot.iterate(filename, step_size="200 MB")):
        ...
        # This assumes that the files are located in the main train directory.
        output_dir = input_filename.parent / "skim"
        output_dir.mkdir(parents=True, exist_ok=True)
        output_filename = output_dir / f"{input_filename.stem}_{i:02d}.root"
        ...
        logger.debug(f"Done with skimming {i}")

    return True


if __name__ == "__main__":
    skim_cross_check_task_to_uniform_output(
        # n_cores=2,
