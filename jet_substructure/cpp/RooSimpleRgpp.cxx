...
void RooSimpleRgpp(TString cFiles2 = "/Users/leticiacunqueiro/2019RawData/MCHard0.4/files.txt")
{
  ...
  TTree* data =
   (TTree*)inputdata->Get("JetSubstructure_Jet_AKTChargedR040_tracks_pT0150_E_scheme_TCRawTree_Data_NoSub_Incl");
  ...
  while (infile2 >> filename2) {
    ...
    TList* list =
     (TList*)input->Get("JetSubstructure_Jet_AKTChargedR040_tracks_pT0150_E_scheme_TCRaw_PythiaDef_NoSub_Incl");
