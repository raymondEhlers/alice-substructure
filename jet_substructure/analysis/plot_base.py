    ...
    for label in ["", "_compare"]:
        ...
        grooming_styling = {
            ...
            f"dynamical_kt_z_cut_02{label}": GroomingMethodStyle(
                ...
                marker=markers[0],
                fillstyle="none",
                label=r"Dynamical grooming $a = 1.0$, $z_{\text{cut}} = 0.2$",
                label_short=r"DyG $a = 1.0$, $z_{\text{cut}} = 0.2$",
                zorder=10,
            ),
            f"dynamical_time_z_cut_02{label}": GroomingMethodStyle(
                ...
                marker=markers[2],
                fillstyle="none",
                label=r"Dynamical grooming $a = 2.0$, $z_{\text{cut}} = 0.2$",
                label_short=r"DyG $a = 2.0$, $z_{\text{cut}} = 0.2$",
                zorder=10,
            ),
            f"dynamical_core_z_cut_02{label}": GroomingMethodStyle(
                ...
                marker=markers[2],
                fillstyle="none",
                label=r"Dynamical grooming $a = 0.5$, $z_{\text{cut}} = 0.2$",
                label_short=r"DyG $a = 0.5$, $z_{\text{cut}} = 0.2$",
                zorder=10,
            ),
