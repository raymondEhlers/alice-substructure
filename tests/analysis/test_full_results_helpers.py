...
def test_two_value_asymmetric_error_calculation() -> None:
    ...
    res = full_results_helpers.AsymmetricErrors.calculate_errors(one, two)
...
def test_one_sided_asymmetric_error_calculation() -> None:
    ...
    res = full_results_helpers.AsymmetricErrors.calculate_errors(one)
    ...
    res_two_value = full_results_helpers.AsymmetricErrors.calculate_errors(one, one)
